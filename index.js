...
// Simulieren Sie eine Datenbank, um den gescannten Barcode zu speichern
let scannedBarcode = null;

// API-Route zum Abrufen des gescannten Barcodes
app.get('/api/scanned-barcode', (req, res) => {
  res.json({ scannedBarcode });
});

// API-Route zum Speichern des gescannten Barcodes
app.post('/api/scanned-barcode', (req, res) => {
  const { scannedBarcode: newScannedBarcode } = req.body;
  if (newScannedBarcode) {
    scannedBarcode = newScannedBarcode;
